 ...
 <div class="container">
      ...
      <form class="form-signin" name="form1" method="post" action="checklogin.php">
        <h2 class="form-signin-heading">Iniciar Sesión</h2>
            ...
            <label for="user">Rut o email</label>
            <br>
        <input name="user" id="user" type="text" class="form-control" placeholder="RUT o Email" autofocus>
         <br>
         <label for="user">Clave</label>
 
        <input name="pass" id="pass" type="password" class="form-control" placeholder="Clave">
        <!-- The checkbox remember me is not implemented yet...
        <label class="checkbox">
          <input type="checkbox" value="remember-me"> Remember me
        </label>
        -->
        <button type="button" name="login" id="login" value="Ingresar"  class="btn btn-lg btn-primary btn-block" type="submit">Ingresar</button>
